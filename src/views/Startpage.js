                ...
                <CardText style={{paddingBottom: "0px"}}>
                  <div className="row">
                    ...
                    <div className="col-md-7">
                      ...
                      This dashboard should help you to manage the information you provided us with when signing up for the service.</p>
                      <p style={{marginBottom: "0"}}>These information might be:</p>
                      <ul>
